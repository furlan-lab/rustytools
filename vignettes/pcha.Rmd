...
```{r}
ParetoTI::install_py_pcha(method = "virtualenv", overwrite_env = T)
suppressPackageStartupMessages({library(ParetoTI)})
library(reticulate)
use_python("/Users/sfurlan/.virtualenvs/reticulate/bin/python")
#use_python("/Users/sfurlan/micromamba/envs/reticulate_scanpy/bin/python")
py_config()
fit_pch(X, noc = as.integer(5), conv_crit = 1e-6, maxiter = 750)
